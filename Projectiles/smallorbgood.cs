...
{
	public class smallorbgood : ModProjectile
	{
				...
				public override void AI()
		{
			...
			{
				int dustnumber = Dust.NewDust(projectile.position, projectile.width, projectile.height, 59, 0f, 0f, 2);
	Main.dust[dustnumber].velocity *= 0.3f;
				...
				public override void Kill(int timeLeft)
		{
			for (int k = 0; k < 5; k++)
			{
				Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 62, projectile.oldVelocity.X * 2f, projectile.oldVelocity.Y * 2f);
			}  
		}
